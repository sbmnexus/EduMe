...
function App() {
  ...
  const enableNotifications = async () => {
    ...
    if (permission === 'granted') {
      ...
      new Notification('EduMe Notifications Enabled', { body: 'You will receive reminders for today\'s study tasks.', icon: '/icon.svg' });
      triggerToast('✓ Notifications enabled');
    } else {
      triggerToast('Please allow notifications in your browser settings.');
    }
  };
